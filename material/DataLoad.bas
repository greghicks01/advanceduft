...
' Columns 7-20 PP03Org
    ...
    sTmpVal = oDicData.Item("name")
    'Org_Name with [n..]
    If InStr(1, oDicData.Item("name"), "[n") > 0 Then
    
        arTmpName = Split(oDicData.Item("name"), "[")
...
' columns 21-37 PP03Pos
    ...
    If InStr(1, oDicData.Item("level"), "APS") > 0 Or InStr(1, oDicData.Item("level"), "EL") > 0 Then
        fillCellValue dstWs, destRow, "Level", oDicData.Item("level")
        
    ElseIf InStr(1, oDicData.Item("level"), "SEC") > 0 Then
        fillCellValue dstWs, destRow, "Level", "DHS-SEC"
        fillCellValue dstWs, destRow, "ESG_for_CAP", "5"
        
    ElseIf InStr(1, oDicData.Item("level"), "CEO") > 0 Then
    ...
    fillCellValue dstWs, destRow, "Level", oDicData.Item("level")
    fillCellValue dstWs, destRow, "PS_Area", oDicData.Item("org")
    
    fillCellValue dstWs, destRow, "PS_Group", oDicData.Item("level")
    ...
    fillCellValue dstWs, destRow, "DT_PP13_Roles", oDicData.Item("roles")
