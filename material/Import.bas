...
' Returns:
    ...
    Set dstWb = Application.Workbooks("CentrelinkSAPConsolRecords.xlsm")
    ...
    Set srcWb = Application.Workbooks.Open(temp & "\Report\Default.xls") '("S:\Automation\SAPQTP\Control Record Scripts from Mark\CentrelinkSAPConsolRecords.xls") '
