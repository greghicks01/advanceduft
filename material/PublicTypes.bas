...
Public Const SPath = "S:\Automation\SAPQTP\QC Project\Test Resources\Data Tables"
'Public Const sExpPath = "W:\2. Test Preparation\01 Automation\QC Project\GUI\Data"
'public const sMyName="CentrelinkSAPConsolRecords.xlsm"
...
Public Declare Function GetComputerName Lib "kernel32.dll" _
...
Public Declare Function OpenClipboard Lib "User32.dll" (ByVal hWndNewOwner As Long) As Long
